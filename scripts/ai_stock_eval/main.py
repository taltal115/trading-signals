...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.batch:
        ...
        cont_ret_min = float(getattr(strat, "continuation_ret_5d_min_pct", 8.0) if strat else 8.0)
        ...
        cont_vol_max = float(getattr(strat, "continuation_vol_ratio_max", 4.0) if strat else 4.0)
