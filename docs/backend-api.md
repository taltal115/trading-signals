...
- `GET /api/events/latest` — latest `stock_events` snapshot (`docId`, `asof_date`, `ts_utc`, `universe_doc_id`, `top_symbols_n`, `rank_by`, `horizon_days`, `events[]`). Session required. See [`docs/stock-events-mvp.md`](stock-events-mvp.md).
